      ...
      <div class="mt-6 space-y-8 sm:gap-6 lg:grid lg:grid-cols-3 lg:space-y-0 xl:gap-4">
        <div class="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow transition hover:bg-gray-700 dark:border-gray-600 dark:bg-gray-800  dark:text-white xl:p-8">
          ...
          <ul role="list" class="mb-8 space-y-4 text-left">
            ...
            <li class="flex items-center space-x-3">
              <svg
                class="h-5 w-5 flex-shrink-0 text-red-500 dark:text-red-400"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <div class="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow transition hover:bg-gray-700 dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
          ...
          <Link
            ...
            class="bg-primary-600 focus:ring-primary-200 dark:focus:ring-primary-900 rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white transition hover:bg-gray-300 hover:text-black focus:ring-4  dark:text-white"
          >
            Get started
          </Link>
        </div>
